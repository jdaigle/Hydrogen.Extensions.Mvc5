// Derived from: https://aspnetwebstack.codeplex.com/SourceControl/changeset/view/5fa60ca38b5837cc843b5d4552113f9a0235c3bf#test/Microsoft.TestCommon/Assert.cs
    ...
    public partial class AssertEx
    {
        ...
        public static ArgumentOutOfRangeException ThrowsArgumentGreaterThan(Action testCode, string paramName, string value, object actualValue = null)
        {
            return ThrowsArgumentOutOfRange(
                        testCode,
                        paramName,
                        String.Format("Value must be greater than {0}.", value), false, actualValue);
        }
        ...
        public static ArgumentOutOfRangeException ThrowsArgumentGreaterThanOrEqualTo(Action testCode, string paramName, string value, object actualValue = null)
        {
            return ThrowsArgumentOutOfRange(
                        testCode,
                        paramName,
                        String.Format("Value must be greater than or equal to {0}.", value), false, actualValue);
        }
        ...
        public static ArgumentOutOfRangeException ThrowsArgumentLessThan(Action testCode, string paramName, string maxValue, object actualValue = null)
        {
            return ThrowsArgumentOutOfRange(
                        testCode,
                        paramName,
                        String.Format("Value must be less than {0}.", maxValue), false, actualValue);
        }
        ...
        public static ArgumentOutOfRangeException ThrowsArgumentLessThanOrEqualTo(Action testCode, string paramName, string maxValue, object actualValue = null)
        {
            return ThrowsArgumentOutOfRange(
                        testCode,
                        paramName,
                        String.Format("Value must be less than or equal to {0}.", maxValue), false, actualValue);
        }
        ...
        {
            string message = String.Format("The value of argument '{0}' ({1}) is invalid for Enum type '{2}'.{3}Parameter name: {0}",
